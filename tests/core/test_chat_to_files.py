...
from espada.core.chat_to_files import parse_diffs
from espada.core.diff import is_similar
...
def capture_stderr_output(func):
    import io
    import sys
...
def test_multi_diff_discard():
    ...
    assert "Multiple diffs found for a/file1.txt. Only the first one is kept." in stderr_io.getvalue()
